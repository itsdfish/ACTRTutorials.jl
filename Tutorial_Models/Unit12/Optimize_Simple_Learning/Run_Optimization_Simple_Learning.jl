...
parm_list = (d = range(.1, .9, length=15), 
...
using StatsPlots
pyplot()
@df df plot(:trial, :std_d, xlabel="trial", ylabel="σ of d", grid=false, group=:design, ylims=(0,.3),
    xaxis=font(12), yaxis=font(12), legendfont=font(9), linewidth=1.5, size=(800,400))
hline!([.08], label="termination point", color=:black, line=:dash)

@df df plot(:trial, :std_blc, xlabel="trial", ylabel="σ of blc", grid=false, group=:design, ylims=(0,1),
    xaxis=font(12), yaxis=font(12), legendfont=font(9), linewidth=1.5, size=(800,400))


@df df plot(:trial, :mean_d, xlabel="Trial", ylabel="Mean d", group=:design, grid=false,
    xaxis=font(12), yaxis=font(12), linewidth=1.5, legendfont=font(9), size=(800,400))
hline!([true_parms.d], label="true")

@df df plot(:trial, :mean_blc, xlabel="trial", ylabel="mean blc", group=:design, grid=false,
    xaxis=font(12), yaxis=font(12), legendfont=font(9), linewidth=1.5, size=(800,400))
hline!([true_parms.blc], label="true")

@df df histogram2d(:delay, :N, group=:design, grid=false, bins=5, xlabel="Delay (seconds)", ylabel="Practices", 
    xaxis=font(12), yaxis=font(12), title = ["Optimal"  "Random"], layout=(2,1), size=(800,400))
