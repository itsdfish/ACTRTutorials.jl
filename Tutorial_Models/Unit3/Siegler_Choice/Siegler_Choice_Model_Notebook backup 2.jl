...
# ╔═╡ e9bfdb48-747a-11ec-0568-71501077bd75
begin
	using StatsPlots, Revise, ACTRModels, Distributions
	using PlutoUI, Turing, DataFrames, Random, StatsBase
	Random.seed!(7884411)
	TableOfContents()
end

# ╔═╡ 1b2ee4fb-30d1-47e2-8b76-6ab7a2466a6c
md"
# Introduction

In this tutorial, you will learn how to develop a model that describes how children perform addition. This model is based on the Siegler addition model in the computational ACT-R tutorial. Unlike the [addition model](../../Unit4/Addition/Addition_Model.ipynb), the Siegler addition model assumes that addition is performed by retrieving addition facts from memory rather than using an explicit counting process. The goal of the tutorial is to develop a model that predicts the probability of answers to addition problems. 
...
$\begin{align}
R_i = \{\mathbf{c}_m \in M : c_m(\rm sum) = \textrm{y}_i \} \textrm{ for } y_i \neq \emptyset
\end{align}$
...
# ╔═╡ f663c4e0-5527-45c8-9d05-1913ad1472e8
md"
# Generate Data
...
# ╔═╡ 30b14dc0-e4e9-4dba-953f-e3058e82b977
md"
The code block below generates 5 blocks of data using parameters $\delta = 16$, $\tau = -.45$, $s=.5$. The data for each trial is a `NamedTuple` consisting of 
...
# ╔═╡ 60166265-5e6b-419a-bfc5-a1efc50ffdfd
md"
Reveal the cell below to see helper functions
"

# ╔═╡ 2f1c7638-4b45-419e-8af0-649a8b1f14e6
begin
...
# ╔═╡ a10ac002-bd39-4629-a428-7885a3eadfa7
...
# ╔═╡ 599b4383-4e5c-4df6-97b2-c087046a10c7
begin
	# mismatch penalty
	δ = 16.0
	# retrieval threshold
...
# ╔═╡ a1f359bf-d014-4487-bf9b-9c8730c936f2
md"
## Define Likelihood Function

In the code block below where the likelihood is defined, the function `computeLL` performs the heavy lifting. 
As with the corresponding function `simulate`, the model objects contructed before computing the log likelihood of each trial-level response. For each trial, the responses are divided into retrieval failures and all other responses. Each log likelihood is weighted by the number of responses associated with the response category. 
"

# ╔═╡ 54aeb9f2-e148-4991-a12d-2fb2cd260d76
begin
...
# ╔═╡ 60b34844-41d7-4a24-8a07-173a4c76dc4a
md"
## Define Model
...
# ╔═╡ 549799f6-2dc8-4a2e-9389-9d8b64dfff0c
...
# ╔═╡ c2c8d3bc-c8ad-40c3-b64a-1d019fa22800
md"
## Estimate Parameters
...
# ╔═╡ c1c639cc-a86c-471a-9937-80a1327e36a0
begin
...
# ╔═╡ 97f6e463-fc43-4ada-b24c-414c6ee3582d
md"
## Results
...
# ╔═╡ 8209f5a0-3d68-4a24-acab-c1cad253b5da
let
	ch = group(chain, :τ)
	p1 = plot(ch, xaxis=font(font_size), yaxis=font(font_size), seriestype=(:traceplot),
	  grid=false, size=(250,100), titlefont=font(font_size))
...
# ╔═╡ 86739a58-500a-4722-a51a-688c2e98fe56
let 
	ch = group(chain, :s)
	p1 = plot(ch, xaxis=font(font_size), yaxis=font(font_size), seriestype=(:traceplot),
	  grid=false, size=(250,100), titlefont=font(font_size))
...
# ╔═╡ e3022781-b086-45e8-9ad0-6983dbf9419b
md"
...
# ╔═╡ 2be417b0-1a6e-4aba-8c75-bfedc2b2689b
begin
...
# ╔═╡ aa16786d-ee3d-4317-91d4-c6b4db9e04d8
let 
...
# ╔═╡ 09fef1bd-efd9-492d-ab85-8d8c2aa1cc2a
md"
# References
...
manifest_format = "2.0"
project_hash = "ea2d25de989ff12d57ed29ee7cdd7ae4e3958543"
