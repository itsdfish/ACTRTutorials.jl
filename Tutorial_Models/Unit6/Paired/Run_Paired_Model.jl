...
p4 = @df fmean_rts plot(:block, :mean_rt, group=(:rep,:retrieved), xlabel="Block", ylabel="Mean RT", xaxis=font(9),
...
sort!(accuracy)
p5 = @df accuracy plot(:block, :accuracy, xlabel="Block", ylabel="Mean Accuracy", xaxis=font(10),
