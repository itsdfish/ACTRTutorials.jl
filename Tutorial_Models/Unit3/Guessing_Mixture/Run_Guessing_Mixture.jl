...
p2 =
    plot(chτ, xaxis = font(font_size), yaxis = font(font_size), seriestype = (:autocorplot),
        grid = false, size = (250, 100), titlefont = font(font_size))
...
chθg = group(chain, :θg)
p1 =
    plot(chθg, xaxis = font(font_size), yaxis = font(font_size), seriestype = (:traceplot),
        grid = false, size = (250, 100), titlefont = font(font_size))
...
p4 = histogram(target, xlabel = "Data", ylabel = "Frequency", xaxis = font(font_size),
    yaxis = font(font_size),
    grid = false, color = :grey, leg = false, size = (600, 300), bar_width = 1,
    title = "Target",
    titlefont = font(font_size))
p5 = histogram(foil, xlabel = "Data", ylabel = "Frequency", xaxis = font(font_size),
    yaxis = font(font_size),
    grid = false, color = :grey, leg = false, size = (600, 300), bar_width = 1,
    title = "Foil",
    titlefont = font(font_size))
