...
In this tutorial, you will develop the likelihood function for the addition model, which is similar to the [count model](./open?path=$path_u4_1) in terms of memory representation and process. As such, you are encouraged complete the tutorial for the count model before completing this tutorial. 

")

# ╔═╡ 739c2d47-cec1-4c95-bc95-3f0401dceffc
md"""

We provide a brief description of the task and model below. The remaining sections provide an outline where you can fill in the details. Much of the code from the count model can be copied, pasted, and modified as necessary. You may check your work with the answer found here. 

## Task

In the addition task, two number displayed on a screen must be added. The participant presses the key corresponding to the answer. To keep things simple, assume that the problem is 2 + 2. As a bonus, see if you can modify the code to work with any addition problem. 

# Addition Model

The addition model is very similar to the count model. Rather than retrieving the solution, the model counts from the beginning number to the solution by successively adding 1 to the previous number until it has counted up to the second number. 
...
where $\mathbf{p}_i = \rm \{(end,4)\}$ is production rule $i$ and the slot "end" holds the goal state of 4. 


## Processing Times

As with the count model, the reaction time is the sum of processing time for each cognitive operation. The trace below details the process for solving the problem 2 + 2. You can use this information to define the likelihood function. 
"""

# ╔═╡ c7599652-6ada-4128-a900-6deb32d41d59
md"
     ...
     0.062   PROCEDURAL             PRODUCTION-FIRED START 
     0.062   PROCEDURAL             CLEAR-BUFFER IMAGINAL 
     0.062   PROCEDURAL             CLEAR-BUFFER VISUAL-LOCATION 
     0.062   VISION                 Find-location 
     0.062   VISION                 SET-BUFFER-CHUNK VISUAL-LOCATION VISUAL-LOCATION0-0 
     0.062   PROCEDURAL             CONFLICT-RESOLUTION 
     0.224   IMAGINAL               SET-BUFFER-CHUNK IMAGINAL QUESTION0 
     0.224   PROCEDURAL             CONFLICT-RESOLUTION 
     0.275   PROCEDURAL             PRODUCTION-FIRED ATTEND-VISUAL-LOCATION 
     0.275   PROCEDURAL             CLEAR-BUFFER VISUAL-LOCATION 
     0.275   PROCEDURAL             CLEAR-BUFFER VISUAL 
     0.275   PROCEDURAL             CONFLICT-RESOLUTION 
     0.364   VISION                 Encoding-complete VISUAL-LOCATION0-0-1 NIL 
     0.364   VISION                 SET-BUFFER-CHUNK VISUAL TEXT0 
     0.364   PROCEDURAL             CONFLICT-RESOLUTION 
     0.406   PROCEDURAL             PRODUCTION-FIRED RETRIEVE-MEANING 
     0.406   PROCEDURAL             CLEAR-BUFFER VISUAL 
     0.406   PROCEDURAL             CLEAR-BUFFER RETRIEVAL 
     0.406   DECLARATIVE            START-RETRIEVAL 
     0.406   PROCEDURAL             CONFLICT-RESOLUTION 
     0.644   DECLARATIVE            RETRIEVED-CHUNK TWO 
     0.644   DECLARATIVE            SET-BUFFER-CHUNK RETRIEVAL TWO 
     0.644   PROCEDURAL             CONFLICT-RESOLUTION 
     0.698   PROCEDURAL             PRODUCTION-FIRED ENCODE-START-NUMBER 
     0.698   PROCEDURAL             CLEAR-BUFFER RETRIEVAL 
     0.698   PROCEDURAL             CLEAR-BUFFER VISUAL-LOCATION 
     0.698   VISION                 Find-location 
     0.698   VISION                 SET-BUFFER-CHUNK VISUAL-LOCATION VISUAL-LOCATION1-0 
     0.698   PROCEDURAL             CONFLICT-RESOLUTION 
     0.763   PROCEDURAL             PRODUCTION-FIRED ATTEND-VISUAL-LOCATION 
     0.763   PROCEDURAL             CLEAR-BUFFER VISUAL-LOCATION 
     0.763   PROCEDURAL             CLEAR-BUFFER VISUAL 
     0.763   PROCEDURAL             CONFLICT-RESOLUTION 
     0.828   VISION                 Encoding-complete VISUAL-LOCATION1-0-0 NIL 
     0.828   VISION                 SET-BUFFER-CHUNK VISUAL TEXT1 
     0.828   PROCEDURAL             CONFLICT-RESOLUTION 
     0.871   PROCEDURAL             PRODUCTION-FIRED RETRIEVE-MEANING 
     0.871   PROCEDURAL             CLEAR-BUFFER VISUAL 
     0.871   PROCEDURAL             CLEAR-BUFFER RETRIEVAL 
     0.871   DECLARATIVE            START-RETRIEVAL 
     0.871   PROCEDURAL             CONFLICT-RESOLUTION 
     0.989   DECLARATIVE            RETRIEVED-CHUNK TWO 
     0.989   DECLARATIVE            SET-BUFFER-CHUNK RETRIEVAL TWO 
     0.989   PROCEDURAL             CONFLICT-RESOLUTION 
     1.033   PROCEDURAL             PRODUCTION-FIRED ENCODE-END-NUMBER 
     1.033   PROCEDURAL             CLEAR-BUFFER RETRIEVAL 
     1.033   PROCEDURAL             CONFLICT-RESOLUTION 
     1.071   PROCEDURAL             PRODUCTION-FIRED INITIALIZE-ADDITION 
     1.071   PROCEDURAL             CLEAR-BUFFER RETRIEVAL 
     1.071   DECLARATIVE            START-RETRIEVAL 
     1.071   PROCEDURAL             CONFLICT-RESOLUTION 
     1.351   DECLARATIVE            RETRIEVED-CHUNK C 
     1.351   DECLARATIVE            SET-BUFFER-CHUNK RETRIEVAL C 
     1.351   PROCEDURAL             CONFLICT-RESOLUTION 
     1.395   PROCEDURAL             PRODUCTION-FIRED INCREMENT-SUM 
     1.395   PROCEDURAL             CLEAR-BUFFER RETRIEVAL 
     1.395   DECLARATIVE            START-RETRIEVAL 
     1.395   PROCEDURAL             CONFLICT-RESOLUTION 
     1.983   DECLARATIVE            RETRIEVED-CHUNK A 
     1.983   DECLARATIVE            SET-BUFFER-CHUNK RETRIEVAL A 
     1.983   PROCEDURAL             CONFLICT-RESOLUTION 
     2.017   PROCEDURAL             PRODUCTION-FIRED INCREMENT-COUNT 
     2.017   PROCEDURAL             CLEAR-BUFFER RETRIEVAL 
     2.017   DECLARATIVE            START-RETRIEVAL 
     2.017   PROCEDURAL             CONFLICT-RESOLUTION 
     2.291   DECLARATIVE            RETRIEVED-CHUNK D 
     2.291   DECLARATIVE            SET-BUFFER-CHUNK RETRIEVAL D 
     2.291   PROCEDURAL             CONFLICT-RESOLUTION 
     2.352   PROCEDURAL             PRODUCTION-FIRED INCREMENT-SUM 
     2.352   PROCEDURAL             CLEAR-BUFFER RETRIEVAL 
     2.352   DECLARATIVE            START-RETRIEVAL 
     2.352   PROCEDURAL             CONFLICT-RESOLUTION 
     2.736   DECLARATIVE            RETRIEVED-CHUNK B 
     2.736   DECLARATIVE            SET-BUFFER-CHUNK RETRIEVAL B 
     2.736   PROCEDURAL             CONFLICT-RESOLUTION 
     2.784   PROCEDURAL             PRODUCTION-FIRED INCREMENT-COUNT 
     2.784   PROCEDURAL             CLEAR-BUFFER RETRIEVAL 
     2.784   DECLARATIVE            START-RETRIEVAL 
     2.784   PROCEDURAL             CONFLICT-RESOLUTION 
     2.818   PROCEDURAL             PRODUCTION-FIRED TERMINATE-ADDITION 
     2.818   PROCEDURAL             CLEAR-BUFFER GOAL 
     2.818   PROCEDURAL             CLEAR-BUFFER IMAGINAL 
     2.818   PROCEDURAL             CLEAR-BUFFER MANUAL 
     2.818   MOTOR                  PRESS-KEY 4 
     2.818   PROCEDURAL             CONFLICT-RESOLUTION 
     2.930   DECLARATIVE            RETRIEVED-CHUNK E 
     2.930   DECLARATIVE            SET-BUFFER-CHUNK RETRIEVAL E 
     2.930   PROCEDURAL             CONFLICT-RESOLUTION 
     3.009   PROCEDURAL             CONFLICT-RESOLUTION 
     3.059   PROCEDURAL             CONFLICT-RESOLUTION 
     3.190   MOTOR                  OUTPUT-KEY #(4 2) 

"

# ╔═╡ 48939fcc-f297-472e-82a9-87538685bac0
md"
# Generate Data

Add `simulate` function in the code block below.
...
Define the likelihood function in the code block below
"
...
The code below should overlay likelihood function over the histogram if `simulate(n_trials; s, blc)` is defined correctly.
"
...
In the block below, define the priors, bounds, model and the object for the Differential Evolution sampler. 
"
...
Estimate the parameters in the code block below.
"
...
Plot and inspect the MCMC samples. This should work if `chains` object is defined and parameters are named `blc` and `s`. 
"
...
Generate the posterior distribution in the code block below
"
...
manifest_format = "2.0"
project_hash = "5101540e2ff0f53c230190d14ac91ee9bcc488ca"
