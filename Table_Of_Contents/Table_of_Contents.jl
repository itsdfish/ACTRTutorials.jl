...
begin
    ...
    path_u2_1 = joinpath(
        pwd(),
        "../Tutorial_Models/Unit2/Simple_RT_1/Simple_RT_Model_1_Notebook.jl"
    )

    path_u2_2 = joinpath(
        pwd(),
        "../Tutorial_Models/Unit2/Simple_RT_2/Simple_RT_Model_2_Notebook.jl"
    )

    path_u2_3 = joinpath(
        pwd(),
        "../Tutorial_Models/Unit2/Simple_RT_3/Simple_RT_Model_3_Notebook.jl"
    )

    path_u2_4 = joinpath(
        pwd(),
        "../Tutorial_Models/Unit2/Simple_RT_4/Simple_RT_Model_4_Notebook.jl"
    )

    path_u3_1 = joinpath(
        pwd(),
        "../Tutorial_Models/Unit3/Guessing_Mixture/Guessing_Mixture_Model_Notebook.jl"
    )

    path_u3_2 = joinpath(
        pwd(),
        "../Tutorial_Models/Unit3/Siegler_Choice/Siegler_Choice_Model_Notebook.jl"
    )

    path_u3_3 = joinpath(
        pwd(),
        "../Tutorial_Models/Unit3/Simple_Learning/Simple_Learning_Notebook.jl"
    )

    path_u3_4 = joinpath(
        pwd(),
        "../Tutorial_Models/Unit3/Serial_Recall_1/Serial_Recall_Model_1_Notebook.jl"
    )

    path_u3_5 = joinpath(
        pwd(),
        "../Tutorial_Models/Unit3/Serial_Recall_2/Serial_Recall_Model_2_Notebook.jl"
    )

    path_u4_1 = joinpath(pwd(), "../Tutorial_Models/Unit4/Count/Count_Model_Notebook.jl")

    path_u4_2 =
        joinpath(pwd(), "../Tutorial_Models/Unit4/Addition/Addition_Model_Notebook.jl")

    path_u5_1 =
        joinpath(pwd(), "../Tutorial_Models/Unit5/Semantic/Semantic_Model_Notebook.jl")

    path_u5_2 =
        joinpath(pwd(), "../Tutorial_Models/Unit5/Simple_PVT/Simple_PVT_Model_Notebook.jl")

    path_u6_1 = joinpath(pwd(), "../Tutorial_Models/Unit6/Paired/Paired_Model_Notebook.jl")

    path_u6_2 = joinpath(
        pwd(),
        "../Tutorial_Models/Unit6/Semantic_FFT/Run_Semantic_FFT_Notebook.jl"
    )

    path_u6_3 =
        joinpath(pwd(), "../Tutorial_Models/Unit6/Siegler_RT/Siegler_RT_Model_Notebook.jl")

    path_u7_1 = joinpath(pwd(), "../Tutorial_Models/Unit7/IBL/IBL_Model_Notebook.jl")

    path_u7_2 = joinpath(
        pwd(),
        "../Tutorial_Models/Unit7/IBL_Inertia/IBL_Inertia_Model_Notebook.jl"
    )

    path_u8_1 = joinpath(
        pwd(),
        "../Tutorial_Models/Unit8/Grouped_Recall_1/Grouped_Recall_1_Notebook.jl"
    )

    path_u8_2 = joinpath(
        pwd(),
        "../Tutorial_Models/Unit8/Grouped_Recall_2/Grouped_Recall_2_Notebook.jl"
    )

    path_u9_1 =
        joinpath(pwd(), "../Tutorial_Models/Unit9/Fan_Model_1/Fan_Model_1_Notebook.jl")

    path_u9_2 =
        joinpath(pwd(), "../Tutorial_Models/Unit9/Fan_Model_1/Fan_Model_2_Notebook.jl")

    path_u10_1 = joinpath(
        pwd(),
        "../Tutorial_Models/Unit10/Visual_Search/Visual_Search_Model_Notebook.jl"
    )

    path_ado = joinpath(
        pwd(),
        "../Tutorial_Models/Unit12/Optimize_Simple_Learning/Simple_Learning_Notebook.jl"
    )

    path_u13_3 =
        joinpath(pwd(), "../Tutorial_Models/Unit13/Fan_Model_Stan/Fan_Model_2_Notebook.jl")
    ...
    path_bayesian =
        joinpath(pwd(), "../Background_Tutorials/bayesian_parameter_estimation.jl")
